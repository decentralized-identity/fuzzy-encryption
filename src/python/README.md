...
3. `corpusSize`: This is the size of the set of allowed words. This means that both the original words and recovery words must be represented by integers in the range 0 .. (`corpusSize` - 1). *This is specified by the user.*
